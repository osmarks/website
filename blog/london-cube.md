...
You may have noticed that the calculation with steel requires ~2500 tonnes of steel per square metre of footprint, or about 22 billion tonnes in total. Global steel production is ~2 billion tonnes per year[^14], and it would not be possible to repurpose all of this.
